...
var MopconIntro = React.createClass({
	...
	componentDidMount: function() {
		...
		var flickerAPI = "https://api.flickr.com/services/rest/?method=flickr.groups.pools.getPhotos&api_key=e8a0be0224faddd8b45f1170c0e555eb&group_id=2768675%40N23&per_page=500&page=2&format=json&nojsoncallback=1";
		$.getJSON( flickerAPI, {
			format: "json"
		}).done(function( data ) {
